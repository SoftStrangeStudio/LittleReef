...
export class ReefRenderer {
  create(scene) {
    ...
    for (const [x, y, z, s] of [
      ...
      [0,-1.35,-3.8,1.25],[-5.6,-1.45,-5.6,1.15],[5.3,-1.55,-6.4,1.05],[2.4,-1.7,-8.2,0.75]
    ]) {
    ...
    const coral = new THREE.Mesh(
      ...
      coral.position.set(-4.2 + (i % 9) * 1.05, -1.8 + coral.geometry.parameters.height / 2, -1.6 - row * 4.1 + (i % 3) * 0.45);
    ...
    scene.add(points);
    return { particles: points, obstacles };
  }
}
